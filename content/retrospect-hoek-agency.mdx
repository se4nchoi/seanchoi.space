...
For my previous endeavor, refer to [] for my experience at EMG Global as a junior software developer. After the one-year contract expired I had fulfilled my work experience requirement — but I didn’t want to return to school right away. I wanted more experience.
...
A short month of preparing and searching for my next destination later, I arrived at Hoek Agency.
...
I took on the role of **co-product lead** for the development of this **full-stack application** tailored specifically for the HR department. This wasn't just about building software; it was about understanding the nuances of their daily operations and translating those into efficient, programmatic solutions.
...
- **Full-Stack Development:** Building both the front-end user interface and the back-end infrastructure to support the application's functionality. The project started in late February and an alpha version for basic clock-in/out was launched by April 1st. You can see the evolution of the Molipdo interface from its early stages to its current form:
    ...
    _Initial Version of Molipdo:_


    _Current Version of Molipdo:_


    _Underlying Code Repositories:_
    I was involved in various internal projects like `molipdo-frontend` and `molipdo-backend`, `insamansa-api`, `insamansa-front`, `jejodo-chat-api`, and `jejodo-chat-front`, `deep-jejodo-life`, as well as maintaining `jejodo-docker` for development environment setup.

- **Automation Implementation:** Focusing on automating manual tasks that were consuming an average of **four hours weekly**. This involved scripting and integrating various processes within the new application.
