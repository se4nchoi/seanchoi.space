...
You can grab your `data_source_id` from the Notion data source as described [here](https://developers.notion.com/docs/upgrade-guide-2025-09-03), but I got mine like so:


![](/notion-images/how-to-use-notion-as-your-blog-post-database-28ef7f81-c89e-80b5-bb7d-cc34d6a256bd.png)


![](/notion-images/how-to-use-notion-as-your-blog-post-database-28ef7f81-c89e-8048-9950-e605a456fbad.png)


![](/notion-images/how-to-use-notion-as-your-blog-post-database-28ef7f81-c89e-80e3-9219-c9ac677ec54f.png)

1. Settings (of the data source)
2. Manage data sources
3. Copy data source ID
