---
title: "How to Persist Images on Notion Pages made from notion-to-md  "
...
![Oh no!](/notion-images/BP-9/299f7f81-c89e-80ac-b15f-d554adf2950e.png)
...
In order for us to use images it needs to _live_ somewhere — and happened that Notion S3 buckets were only a temporary place. Self-hosting the images resolved the issue for me, while it increased the network data usages on Vercel. Should the day come when I would need to switch to a paid plan for Vercel, it would be a great day to mark a milestone of traffics!
